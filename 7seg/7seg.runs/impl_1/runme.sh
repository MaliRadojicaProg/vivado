...
HD_PWD='/home/marko/Documents/vivadoProjekti/vivado/7seg/7seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sevenseg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sevenseg.tcl -notrace
