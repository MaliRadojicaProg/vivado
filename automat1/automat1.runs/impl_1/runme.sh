...
HD_PWD='/home/marko/vivadoProjekti/automat1/automat1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log automat1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source automat1.tcl -notrace
