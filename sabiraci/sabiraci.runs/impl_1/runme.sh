...
HD_PWD='/home/marko/vivadoProjekti/sabiraci/sabiraci.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add8.tcl -notrace
