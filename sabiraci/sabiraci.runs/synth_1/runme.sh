...
HD_PWD='/home/marko/vivadoProjekti/sabiraci/sabiraci.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add8.tcl
