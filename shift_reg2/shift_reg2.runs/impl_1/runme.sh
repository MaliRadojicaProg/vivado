...
HD_PWD='/home/marko/vivadoProjekti/shift_reg2/shift_reg2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_reg2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shift_reg2.tcl -notrace
