...
HD_PWD='/home/marko/vivadoProjekti/shift_reg2/shift_reg2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_reg2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shift_reg2.tcl
