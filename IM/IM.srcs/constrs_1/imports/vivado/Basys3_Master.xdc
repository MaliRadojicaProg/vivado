...
set_property PACKAGE_PIN W5 [get_ports clk]
	...
	create_clock -add -name sys_clk_pin -period 5.50 -waveform {0 5} [get_ports clk]
...
set_property PACKAGE_PIN V2 [get_ports r_addr[3]]
	set_property IOSTANDARD LVCMOS33 [get_ports r_addr[3]]
set_property PACKAGE_PIN T3 [get_ports r_addr[2]]
	set_property IOSTANDARD LVCMOS33 [get_ports r_addr[2]]
set_property PACKAGE_PIN T2 [get_ports r_addr[1]]
	set_property IOSTANDARD LVCMOS33 [get_ports r_addr[1]]
set_property PACKAGE_PIN R3 [get_ports r_addr[0]]
	set_property IOSTANDARD LVCMOS33 [get_ports r_addr[0]]
...
# set_property PACKAGE_PIN U19 [get_ports r_data[7]]
# 	set_property IOSTANDARD LVCMOS33 [get_ports r_data[7]]
# set_property PACKAGE_PIN V19 [get_ports r_data[6]]
# 	set_property IOSTANDARD LVCMOS33 [get_ports r_data[6]]
# set_property PACKAGE_PIN W18 [get_ports r_data[5]]
# 	set_property IOSTANDARD LVCMOS33 [get_ports r_data[5]]
#set_property PACKAGE_PIN U15 [get_ports r_data[4]]
