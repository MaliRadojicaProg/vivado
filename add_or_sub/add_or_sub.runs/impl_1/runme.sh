...
HD_PWD='/home/marko/vivadoProjekti/add_or_sub/add_or_sub.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add_or_sub.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add_or_sub.tcl -notrace
