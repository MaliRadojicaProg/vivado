...
HD_PWD='/home/marko/vivadoProjekti/add_or_sub/add_or_sub.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_or_sub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_or_sub.tcl
