...
HD_PWD='/home/marko/vivadoProjekti/counter/counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log count16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source count16.tcl
