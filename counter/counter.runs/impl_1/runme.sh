...
HD_PWD='/home/marko/vivadoProjekti/counter/counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log count16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source count16.tcl -notrace
