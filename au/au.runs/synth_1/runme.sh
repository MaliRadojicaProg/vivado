...
HD_PWD='/home/marko/vivadoProjekti/au/au.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log auoptJ.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source auoptJ.tcl
