...
HD_PWD='/home/marko/vivadoProjekti/au/au.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log auoptJ.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source auoptJ.tcl -notrace
