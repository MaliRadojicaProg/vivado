...
HD_PWD='/home/marko/Documents/vivadoProjekti2/vivado/IM/IM/IM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IM.tcl -notrace
