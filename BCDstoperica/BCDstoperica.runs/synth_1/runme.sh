...
HD_PWD='/home/marko/Documents/vivadoProjekti/BCDstoperica/BCDstoperica.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sseg_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sseg_mux.tcl
