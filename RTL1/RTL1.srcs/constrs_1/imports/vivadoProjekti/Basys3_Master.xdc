...
#set_property PACKAGE_PIN W5 [get_ports clk]
	...
	create_clock -add -name sys_clk_pin -period 5.7 -waveform {0 5} [get_ports clk]
...
#set_property PACKAGE_PIN W17 [get_ports S2[0]]
#	set_property IOSTANDARD LVCMOS33 [get_ports S2[0]]
#set_property PACKAGE_PIN W15 [get_ports Skr1]
#	set_property IOSTANDARD LVCMOS33 [get_ports Skr1]
#set_property PACKAGE_PIN V15 [get_ports Skr2]
#	set_property IOSTANDARD LVCMOS33 [get_ports Skr2]
#set_property PACKAGE_PIN W14 [get_ports Sa]
#	set_property IOSTANDARD LVCMOS33 [get_ports Sa]
#set_property PACKAGE_PIN W13 [get_ports Sb]
#	set_property IOSTANDARD LVCMOS33 [get_ports Sb]
#set_property PACKAGE_PIN V2 [get_ports En1]
#	set_property IOSTANDARD LVCMOS33 [get_ports En1]
#set_property PACKAGE_PIN T3 [get_ports En2]
#	set_property IOSTANDARD LVCMOS33 [get_ports En2]
#set_property PACKAGE_PIN T2 [get_ports En3]
...
# set_property PACKAGE_PIN U19 [get_ports R3]
