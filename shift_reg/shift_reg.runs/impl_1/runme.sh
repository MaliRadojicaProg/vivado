...
HD_PWD='/home/marko/vivadoProjekti/shift_reg/shift_reg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_reg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shift_reg.tcl -notrace
