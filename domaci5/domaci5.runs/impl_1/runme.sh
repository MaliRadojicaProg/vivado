...
HD_PWD='/home/marko/vivadoProjekti/domaci5/domaci5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flip.tcl -notrace
