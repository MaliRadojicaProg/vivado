...
HD_PWD='/home/marko/vivadoProjekti/domaci5/domaci5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flip.tcl
